        ...
        <nav className="bg-white">
            <div className="container px-3 flex justify-between items-center py-3">
                <div className='flex gap-2 items-center'>
                    ...
                    <Link to="/"><h2 className="text-3xl font-bold">big<span className="text-yellow-500">Chef</span></h2></Link>
                </div>
                ...
                <ul className={`flex items-center duration-300 flex-col py-5 md:p-0 text-white bg-opacity-90 md:text-black top-20 bg-black md:bg-transparent w-full md:w-auto md:flex-row gap-6 absolute md:static z-50 ${toggle ? "left-0" : "-left-full"}`}>
                    ...
                    <li>{
                        user ? <button onClick={logOut} className="bg-yellow-500 hover:bg-amber-500  px-4 py-2  text-white">LogOut</button> : <button className="bg-yellow-500 text-xl font-semibold hover:bg-amber-500 px-4 py-2 rounded-md text-white"><Link to="/login">Login</Link></button>
                    }
                    </li>
                </ul>
            </div>
