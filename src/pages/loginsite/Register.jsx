    ...
    return (
        <main>
            ...
            <div className='max-w-[1240px] mx-auto mt-20 bg-slate-200'>
                <h1 className='text-center text-5xl font-bold'>Please <span className='text-yellow-600'>Register</span></h1>
                <div className='text-center py-5 bg-slate-200 rounded md:w-[500px]  mx-auto my-5'>
                    ...
                    <button className='w-[80%] bg-yellow-600 mx-auto rounded py-2 my-3 ' >Register</button>
                </div>
            </div>
        </main>
    );
